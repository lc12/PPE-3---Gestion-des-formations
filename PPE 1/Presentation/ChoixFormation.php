...
include_once "../CoucheBD/dbCondition.php";
include_once "../CoucheBD/dbsearch.php";
?>
...
?>
 <div id="f2">
	...
	<table>
	<tr><th>Intitulé</th><th>Date</th><th>Durée</th><th>Lieu</th><th>Nombre de crédit</th><th>Nombre de jours<th>Nom du Prestataire</th><th>Inscription</tr>
		<?php
		...
		?>
		<input name="idform" value =<?php echo  $result->IdFormation?> type ="hidden">
		<?php 
		echo '</tr>';
